...
exports.friendsRouter.get('/', (req, res, next) => { (0, validatorMiddleware_1.validatorMiddleware)(res, friends_1.getAllFriendsSchema, req === null || req === void 0 ? void 0 : req.query, next); }, friendsController.getAllFriends);
